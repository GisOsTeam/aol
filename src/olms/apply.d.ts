...
export function applyStyle(
  layer: VectorTileLayer | VectorLayer<any>,
  glStyle: string | any,
  sourceOrLayers?: string | Array<string>,
  optionsOrPath?: Options | string,
...
export function applyBackground(
  mapOrLayer: Map | VectorTileLayer,
  glStyle: any | string,
  options?: Options
): Promise<any>;
/**
 ...
 * @private
 */
export function setupVectorSource(
  glSource: any,
  styleUrl: string | undefined,
  options: Options
): Promise<import('ol/source/VectorTile').default>;
/**
...
export function setFeatureState(
  mapOrLayer: Map | VectorLayer<any> | VectorTileLayer,
 ...
 * @private
 */
declare function finalizeLayer(
  layer: Layer,
