...
describe('aol.wfs', () => {
  test('register', () => {
    ...
    expect((wfsSource.getUrl() as FeatureUrlFunction)([0, 0, 0, 0], 0, projection)).toEqual(
      'https://dservices2.arcgis.com/ZQgQTuoyBrtmoGdP/arcgis/services/Seattle_Downtown_Features/WFSServer?service=WFS&version=2.0.0&request=GetFeature&TypeName=Seattle_Downtown_Features:Buildings&outputFormat=GEOJSON&srsname=EPSG:4326&bbox=0,0,0,0,EPSG:4326'
    );
  });
});
